...
Scoring over 6 dimensions (1-5):

| Dimension | Weight | 5 = ... | 1 = ... |
|-----------|--------|---------|---------|
| Signal for target roles | 25% | Directly shows a JD skill | Unrelated |
| Uniqueness | 20% | Nobody has done this | Everyone has it |
| Demo-ability | 20% | Live demo in 2 min | Code only, nothing visual |
...
3. **Postmortem**: what worked, what did not, mitigations.
