...
10. Build the competency grid from JD requirements (6-8 keyword phrases)
...
- **Section headers**: Space Grotesk 13px, uppercase, letter-spacing 0.05em, primary cyan color
