...
Weighted 10-dimension scoring matrix:
...
For each offer: score per dimension, total weighted score.
Final ranking + recommendation with time-to-offer considerations.

Ask the user for the offers if they are not already in context. They can be text, URLs, or references to offers already evaluated in the tracker.
